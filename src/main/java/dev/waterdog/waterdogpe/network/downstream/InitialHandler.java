...
import dev.waterdog.waterdogpe.event.defaults.DownstreamPacketHandler;
...
public class InitialHandler extends AbstractDownstreamHandler {
    ...
    public final boolean handle(StartGamePacket packet) {
        ...
        this.player.setPluginDownstreamHandler(new DownstreamPacketHandler(((BedrockDefaultClient) player.getDownstream()).getSession().getSession()));
